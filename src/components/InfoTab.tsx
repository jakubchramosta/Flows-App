...
const InfoTab = () => {
  ...
  return (
    <div className="absolute bottom-20 left-3 max-w-[calc(100vw/1.25)] rounded-md border border-input bg-background p-2.5 shadow-sm">
      <div className="p-3">
        <p>
        ...
        {editationMode ? <InfoTabContentEditationMode /> : "Doplni se"}
        <hr className="my-2 border-t border-gray-300" />
